local NvimTree = {
		NvimTreeFolderIcon = {fg = C.info_yellow, },
		NvimTreeIndentMarker = {fg = "#c5c5c5", },
		NvimTreeNormal = {fg = C.light_gray, bg = C.bg, },
		NvimTreeVertSplit = {fg = C.dark_gray, bg = C.bg, },
		NvimTreeFolderName = {fg = C.yellow, },
		NvimTreeOpenedFolderName = {fg = C.yellow, style = "bold", },
		...
		NvimTreeRootFolder = {fg = C.dark_gray, style = "bold", },
